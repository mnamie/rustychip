...
export class RustyChipWasm {
    ...
    free() {
        ...
        wasm.__wbg_rustychipwasm_free(ptr);
    }
    /**
    */
    constructor() {
    ...
    */
    reset() {
        wasm.rustychipwasm_reset(this.__wbg_ptr);
    }
    /**
    */
    cycle() {
        wasm.rustychipwasm_cycle(this.__wbg_ptr);
    }
    /**
    */
    tick_timers() {
        wasm.rustychipwasm_tick_timers(this.__wbg_ptr);
    }
    /**
    ...
    */
    keypress(evt, pressed) {
        wasm.rustychipwasm_keypress(this.__wbg_ptr, addHeapObject(evt), pressed);
    }
    /**
    * @param {Uint8Array} data
    */
    load_rom(data) {
        wasm.rustychipwasm_load_rom(this.__wbg_ptr, addHeapObject(data));
    }
    /**
    * @param {number} scale
    */
    draw(scale) {
        wasm.rustychipwasm_draw(this.__wbg_ptr, scale);
    }
}
